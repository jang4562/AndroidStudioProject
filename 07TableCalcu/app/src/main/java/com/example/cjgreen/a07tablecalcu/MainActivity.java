package com.example.cjgreen.a07tablecalcu;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        });//end of btnAdd.setOnTouchListener
        ...
        });//end of btnSub.setOnTouchListener
        ...
        });//end of btnMul.setOnTouchListener
        ...
        });//end of btnDiv.setOnTouchListener
